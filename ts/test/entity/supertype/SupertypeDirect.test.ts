...
describe('SupertypeDirect', async () => {
  ...
  test('direct-list-supertype', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-supertype', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['POKEMON_TCG_TEST_SUPERTYPE_ENTID']
