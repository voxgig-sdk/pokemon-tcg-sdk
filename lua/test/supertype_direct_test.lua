...
describe("SupertypeDirect", function()
  it("should direct-list-supertype", function()
    local setup = supertype_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-supertype", setup.live and "live" or "unit")
...
function supertype_direct_setup(mockres)
  runner.load_env_local()

  local calls = {}

  local env = runner.env_override({
    ["POKEMON_TCG_TEST_SUPERTYPE_ENTID"] = {},
