...
describe("RarityDirect", function()
  it("should direct-list-rarity", function()
    local setup = rarity_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-rarity", setup.live and "live" or "unit")
...
function rarity_direct_setup(mockres)
