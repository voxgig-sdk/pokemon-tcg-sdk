...
describe("SubtypeDirect", function()
  it("should direct-list-subtype", function()
    local setup = subtype_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-subtype", setup.live and "live" or "unit")
...
function subtype_direct_setup(mockres)
