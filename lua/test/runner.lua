...
function runner.env_override(m)
  local live = runner.getenv("POKEMON_TCG_TEST_LIVE")
  local override = runner.getenv("POKEMON_TCG_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("POKEMON_TCG_TEST_EXPLAIN")
