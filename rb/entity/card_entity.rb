...
class CardEntity
  ...
  # @return [Card, Hash] the loaded Card; raises PokemonTcgError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Card>, Array] the matching Card items; raises PokemonTcgError on failure
