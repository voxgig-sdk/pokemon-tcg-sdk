...
class SubtypeEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set POKEMONTCG_TEST_SUBTYPE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def subtype_basic_setup(extra)
  ...
  entid_env_raw = ENV["POKEMONTCG_TEST_SUBTYPE_ENTID"]
