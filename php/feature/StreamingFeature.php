...
// PokemonTcg SDK streaming feature
...
class PokemonTcgStreamingFeature extends PokemonTcgBaseFeature
{
    ...
    private function _iterate(PokemonTcgResult $result): \Generator
    {
    ...
    private function _streamable(PokemonTcgContext $ctx): bool
    {
