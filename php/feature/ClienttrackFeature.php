...
// PokemonTcg SDK clienttrack feature
...
class PokemonTcgClienttrackFeature extends PokemonTcgBaseFeature
{
    ...
    public function PostConstruct(PokemonTcgContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'PokemonTcg-SDK';
