...
// PokemonTcg SDK idempotency feature
...
class PokemonTcgIdempotencyFeature extends PokemonTcgBaseFeature
{
    ...
    private function _mutating(PokemonTcgContext $ctx): bool
    {
