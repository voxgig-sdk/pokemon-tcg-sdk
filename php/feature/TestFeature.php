...
// PokemonTcg SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class PokemonTcgTestFeature extends PokemonTcgBaseFeature
{
    ...
    public function init(PokemonTcgContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (PokemonTcgContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = PokemonTcgParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (PokemonTcgContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(PokemonTcgContext $ctx, $op, $args): array
    {
