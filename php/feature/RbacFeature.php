...
class PokemonTcgRbacFeature extends PokemonTcgBaseFeature
{
    ...
    private function _required(PokemonTcgContext $ctx): ?string
    {
    ...
    private function _reject(PokemonTcgContext $ctx, string $required): void
    {
    ...
    private function _track(PokemonTcgContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
