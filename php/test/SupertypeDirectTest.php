...
class SupertypeDirectTest extends TestCase
{
    public function test_direct_list_supertype(): void
    {
        $setup = supertype_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-supertype", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
