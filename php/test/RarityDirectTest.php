...
class RarityDirectTest extends TestCase
{
    public function test_direct_list_rarity(): void
    {
        $setup = rarity_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-rarity", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
