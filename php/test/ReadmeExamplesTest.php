...
// PokemonTcg SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (PokemonTcgSDK::test)
...
{
    private const SDK_CLASS = 'PokemonTcgSDK';
    ...
    private const SDK_BASE = 'pokemontcg_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../pokemontcg_sdk.php';
