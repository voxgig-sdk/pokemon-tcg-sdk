...
class SubtypeDirectTest extends TestCase
{
    public function test_direct_list_subtype(): void
    {
        $setup = subtype_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-subtype", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
