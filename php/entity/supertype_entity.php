...
// PokemonTcg SDK Supertype entity
...
class SupertypeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SupertypeEntity($this->_client, $opts);
    }

    /**
     * @param Supertype|array $args Supertype data (assoc-array) to store.
     */
    ...
    /**
     * @return Supertype|array The current Supertype data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Supertype fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Supertype fields).
     */
    ...
    /**
     * List Supertype items matching the given filter.
     *
     * @param SupertypeListMatch|array|null $reqmatch Match filter (any subset
     *   of Supertype fields) as an assoc-array; SupertypeListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Supertype[]|array A list of Supertype items as assoc-arrays at
