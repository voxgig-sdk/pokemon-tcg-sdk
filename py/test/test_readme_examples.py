# PokemonTcg SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions PokemonTcgSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both PokemonTcgSDK(...) and PokemonTcgSDK.test(...) become
#      PokemonTcgSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "pokemontcg_sdk"
_SDK_CLASS = "PokemonTcgSDK"
