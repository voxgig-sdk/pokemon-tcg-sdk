...
class PokemonTcgTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = PokemonTcgTestRunner.getenv("POKEMONTCG_TEST_LIVE")
        override = PokemonTcgTestRunner.getenv("POKEMONTCG_TEST_OVERRIDE")
        ...
        explain = PokemonTcgTestRunner.getenv("POKEMONTCG_TEST_EXPLAIN")
