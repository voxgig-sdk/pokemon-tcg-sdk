...
from pokemontcg_sdk.utility import register

# Load features
from pokemontcg_sdk.feature.base_feature import PokemonTcgBaseFeature
from pokemontcg_sdk.features import _has_feature, _make_feature
...
class PokemonTcgSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = PokemonTcgUtility()
        self._utility = utility

        from pokemontcg_sdk.config import shared_config
    ...
    def get_utility(self):
        return PokemonTcgUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("PokemonTcgSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Subtype(self, data=None) -> "SubtypeEntity":
        ...
        from pokemontcg_sdk.entity.subtype_entity import SubtypeEntity
    ...
    def Supertype(self, data=None) -> "SupertypeEntity":
        ...
        from pokemontcg_sdk.entity.supertype_entity import SupertypeEntity
        return SupertypeEntity(self, data)


    def Type(self, data=None) -> "TypeEntity":
        """Entity factory: client.Type().list() / client.Type().load({"id": ...})."""
        from pokemontcg_sdk.entity.type_entity import TypeEntity
