...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/pokemon-tcg` | `npm install @voxgig-sdk/pokemon-tcg` |
| Python | `voxgig-sdk-pokemon-tcg` | `pip install voxgig-sdk-pokemon-tcg` |
| PHP | `voxgig-sdk/pokemon-tcg` | `composer require voxgig-sdk/pokemon-tcg` |
| Golang | `github.com/voxgig-sdk/pokemon-tcg-sdk/go` | `go get github.com/voxgig-sdk/pokemon-tcg-sdk/go` |
| Ruby | `voxgig-sdk-pokemon-tcg` | `gem install voxgig-sdk-pokemon-tcg` |
| Lua | `voxgig-sdk-pokemon-tcg` | `luarocks install voxgig-sdk-pokemon-tcg` |
