...
func registerSDKWords(r *eng.Registry, client *sdk.PokemonTcgSDK) {
...
func runOp(client *sdk.PokemonTcgSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
