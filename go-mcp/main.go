// Command PokemonTcg-mcp is an MCP server exposing the PokemonTcg
// SDK as MCP tools.
//
// Two tools are registered:
//
//	PokemonTcg_list  — list records of an entity
//	PokemonTcg_load  — load a single record of an entity
//
