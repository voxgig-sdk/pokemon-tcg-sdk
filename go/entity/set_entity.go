...
func NewSetEntity(client *core.PokemonTcgSDK, entopts map[string]any) *SetEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SetEntity) GetName() string { return e.name }
...
func (e *SetEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SetEntity) Deleted() bool {
	return e.deleted
}


func (e *SetEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSetEntity(e.client, opts)
}

func (e *SetEntity) Data(args ...any) any {
...
func (e *SetEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Set; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SetEntity) DataTyped(data ...Set) Set {
	if len(data) > 0 {
		return typedFrom[Set](e.Data(asMap(data[0])))
	}
	return typedFrom[Set](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Set (all fields
// optional at the wire level).
func (e *SetEntity) MatchTyped(match ...Set) Set {
	if len(match) > 0 {
		return typedFrom[Set](e.Match(asMap(match[0])))
	}
	return typedFrom[Set](e.Match())
}
...
func (e *SetEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SetEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SetLoadMatch and returns an Set. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *SetEntity) LoadTyped(reqmatch SetLoadMatch, ctrl map[string]any) (Set, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Set{}, err
	}
	return typedFrom[Set](res), nil
}




func (e *SetEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// SetListMatch and returns []Set. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *SetEntity) ListTyped(reqmatch SetListMatch, ctrl map[string]any) ([]Set, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Set](res), nil
}



func (e *SetEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SetEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SetEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SetEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
