...
func NewSubtypeEntity(client *core.PokemonTcgSDK, entopts map[string]any) *SubtypeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SubtypeEntity) GetName() string { return e.name }
...
func (e *SubtypeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SubtypeEntity) Deleted() bool {
	return e.deleted
}


func (e *SubtypeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSubtypeEntity(e.client, opts)
}

func (e *SubtypeEntity) Data(args ...any) any {
...
func (e *SubtypeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Subtype; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SubtypeEntity) DataTyped(data ...Subtype) Subtype {
	if len(data) > 0 {
		return typedFrom[Subtype](e.Data(asMap(data[0])))
	}
	return typedFrom[Subtype](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Subtype (all fields
// optional at the wire level).
func (e *SubtypeEntity) MatchTyped(match ...Subtype) Subtype {
	if len(match) > 0 {
		return typedFrom[Subtype](e.Match(asMap(match[0])))
	}
	return typedFrom[Subtype](e.Match())
}
...
func (e *SubtypeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SubtypeEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *SubtypeEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SubtypeListMatch and returns []Subtype. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *SubtypeEntity) ListTyped(reqmatch SubtypeListMatch, ctrl map[string]any) ([]Subtype, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Subtype](res), nil
}



func (e *SubtypeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SubtypeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SubtypeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SubtypeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
