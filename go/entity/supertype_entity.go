...
func NewSupertypeEntity(client *core.PokemonTcgSDK, entopts map[string]any) *SupertypeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SupertypeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
