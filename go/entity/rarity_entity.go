...
func NewRarityEntity(client *core.PokemonTcgSDK, entopts map[string]any) *RarityEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RarityEntity) GetName() string { return e.name }
...
func (e *RarityEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RarityEntity) Deleted() bool {
	return e.deleted
}


func (e *RarityEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRarityEntity(e.client, opts)
}

func (e *RarityEntity) Data(args ...any) any {
...
func (e *RarityEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Rarity; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RarityEntity) DataTyped(data ...Rarity) Rarity {
	if len(data) > 0 {
		return typedFrom[Rarity](e.Data(asMap(data[0])))
	}
	return typedFrom[Rarity](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Rarity (all fields
// optional at the wire level).
func (e *RarityEntity) MatchTyped(match ...Rarity) Rarity {
	if len(match) > 0 {
		return typedFrom[Rarity](e.Match(asMap(match[0])))
	}
	return typedFrom[Rarity](e.Match())
}
...
func (e *RarityEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RarityEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *RarityEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RarityListMatch and returns []Rarity. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *RarityEntity) ListTyped(reqmatch RarityListMatch, ctrl map[string]any) ([]Rarity, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Rarity](res), nil
}



func (e *RarityEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RarityEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RarityEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RarityEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
