...
## Install
```bash
go get github.com/voxgig-sdk/pokemon-tcg-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/pokemon-tcg-sdk=../path/to/github.com/voxgig-sdk/pokemon-tcg-sdk
```
...
```
github.com/voxgig-sdk/pokemon-tcg-sdk/
...
The root package (`github.com/voxgig-sdk/pokemon-tcg-sdk`) re-exports everything needed
