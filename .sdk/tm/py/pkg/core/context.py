...
from projectname_sdk.core.control import PokemonTcgControl
...
class PokemonTcgContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, PokemonTcgSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, PokemonTcgResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, PokemonTcgResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return PokemonTcgError(code, msg, self)
