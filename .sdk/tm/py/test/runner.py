...
class PokemonTcgTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = PokemonTcgTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = PokemonTcgTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = PokemonTcgTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
