...
// PokemonTcg SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class PokemonTcgTransformResponse
{
    public static function call(PokemonTcgContext $ctx): mixed
    {
        ...
        $transform = PokemonTcgHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
