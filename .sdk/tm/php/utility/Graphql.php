...
// PokemonTcg SDK utility: graphql
//
...
class PokemonTcgGraphql
{
    ...
    // equivalent.
    public static function body(PokemonTcgContext $ctx): mixed
    {
    ...
    public static function errors(PokemonTcgContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
