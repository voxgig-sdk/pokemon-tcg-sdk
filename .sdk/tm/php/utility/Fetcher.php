...
// PokemonTcg SDK utility: fetcher

class PokemonTcgFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; PokemonTcgSDK/1.0)';
    ...
    public static function call(PokemonTcgContext $ctx, string $fullurl, array $fetchdef): array
    {
