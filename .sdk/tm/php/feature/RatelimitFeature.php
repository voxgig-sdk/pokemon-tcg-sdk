...
// PokemonTcg SDK ratelimit feature
...
class PokemonTcgRatelimitFeature extends PokemonTcgBaseFeature
{
    ...
    private function _acquire(PokemonTcgContext $ctx): void
    {
    ...
    private function _track(PokemonTcgContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
