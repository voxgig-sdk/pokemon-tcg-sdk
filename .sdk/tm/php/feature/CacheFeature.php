...
class PokemonTcgCacheFeature extends PokemonTcgBaseFeature
{
    ...
    private function _through(PokemonTcgContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
