...
class PokemonTcgNetsimFeature extends PokemonTcgBaseFeature
{
    ...
    private function _simulate(PokemonTcgContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(PokemonTcgContext $ctx, array $applied): void
    {
        $client = $this->client;
