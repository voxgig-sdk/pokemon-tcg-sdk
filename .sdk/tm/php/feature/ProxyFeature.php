...
class PokemonTcgProxyFeature extends PokemonTcgBaseFeature
{
    ...
    public function init(PokemonTcgContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (PokemonTcgContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
