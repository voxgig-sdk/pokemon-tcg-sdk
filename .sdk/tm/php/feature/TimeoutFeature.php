...
// PokemonTcg SDK timeout feature
...
class PokemonTcgTimeoutFeature extends PokemonTcgBaseFeature
{
    ...
    private function _with_timeout(PokemonTcgContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(PokemonTcgContext $_ctx, float $ms): void
    {
        $client = $this->client;
